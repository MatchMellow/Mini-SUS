...
/* package Mini-SUS-0.1.0.0 */
#ifndef VERSION_Mini_SUS
#define VERSION_Mini_SUS "0.1.0.0"
#endif /* VERSION_Mini_SUS */
#ifndef MIN_VERSION_Mini_SUS
#define MIN_VERSION_Mini_SUS(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Mini_SUS */
